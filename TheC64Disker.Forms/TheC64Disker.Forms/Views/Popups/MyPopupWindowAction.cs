//----------------------------------------------------------------------------
// <copyright file="MyPopupWindowAction.cs"
...
// <description>
//      A custom popup window interaction action.
// </description>
// <version>v1.0.0 2018-06-14T21:32:00+02</version>
//
// Based on:
//
// Prism Library Source Code - PopupWindowAction.cs
...
namespace at.markusegger.Application.TheC64Disker.Views.Popups
{
    ...
    public class MyPopupWindowAction : TriggerAction<FrameworkElement>
    {
        ...
        /// </summary>
        public static readonly BindableProperty WindowContentTypeProperty =
            BindableProperty.Register(
                "WindowContentType",
                typeof(Type),
                typeof(MyPopupWindowAction),
        ...
        /// </summary>
        public static readonly BindableProperty CenterOverAssociatedObjectProperty =
            BindableProperty.Register(
        ...
        /// </summary>
        public static readonly BindableProperty WindowStartupLocationProperty =
            BindableProperty.Register(
        ...
        /// </summary>
        public static readonly BindableProperty WindowStyleProperty =
            BindableProperty.Register(
                "WindowStyle",
                typeof(Style),
                typeof(MyPopupWindowAction),
        ...
        protected virtual Window CreateDefaultWindow(INotification notification)
        {
            ...
            {
                window = new MyConfirmationWindow() { Confirmation = confirmation };
            }
            else
            {
                window = new MyNotificationWindow() { Notification = notification };
            }
